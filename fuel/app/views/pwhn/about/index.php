...
<div class="page-header">
    ...
    <div class="container">
        <div class="image">
            ...
            <a href="https://ibb.co/94czQyN"><img src="https://avatars.githubusercontent.com/u/97863393?v=4"
                    alt="IMG-5361-2" border="0" height="400px"></a>
        </div>
        <div class="text">
            <h4>Alex Glimco</h4>
            <h5>
                I wish to use my degree, education, and skills from CSU to better myself as I grow in the industry and
                ultimately aim to work for a forward-thinking company that values the environment, innovation, and human
                equality.
            </h5>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="text">
            <h5>
                Jack Matthews is a  sophmore at Colorado State University, and wishes to pursue a degree in computer science to gain a comfortable career.
